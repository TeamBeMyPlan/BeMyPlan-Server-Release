...
fun validateNotExistsUserName(userRepository: UserRepository, name: String) {
    if (userRepository.existsByName(name)) {
        throw ConflictException("이미 존재하는 닉네임 ${name} 입니다")
    }
}

fun validateNotExistsUser(userRepository: UserRepository, socialId: String, socialType: UserSocialType) {
