...
public class TempPlanController {
    ...
    public TempPlanResponse getTempPlan() {
        return TempPlanResponse.of(
            -1L,
            "자연스러운 제주",
            TempUserInfoResponse.of(-1L, "린지"),
            List.of(
                TempScheduleDetailResponse.of(
                    List.of(
                        TempSpotDetailResponse.of("아가스트 요가", 33.2923113681473, 126.255567603996,
                            "1. 첫째 날 숙박한 항공우주호텔은 아가스트 요가원이랑 10분 거리에 위치했어서 이른 아침 요가도 무리 없이 들을 수 있었답니다~!\n2. 주차공간은 요가원 앞에 차를 댈 수 있는 공간이 있어요.\n 3. 맨 뒷 자리나 끝 쪽에서 수련을 한다면 사람들에게 피해주지 않는 선에서 핸드폰을 세워 놓고 영상 촬영하면 좋을 것 같아요. 수업 전에 선생님께 미리 양해 구하기 필수!"
                            ,
                        ...
                        TempSpotDetailResponse.of("리틀넥 제주애월", 33.4629252295724, 126.309244734174,
                            "1. 주차는 공용주차장을 이용해야하며 5만원 이상은 무료주차이고 그 이하는 2,000원에 가능한데 영수증 꼭꼭 지참해야 한다는 점 잊지마세요!\n"
                        ...
                        TempSpotDetailResponse.of("한담해안산책로", 33.4590846763959, 126.310575628004,
                            "1. 바닷가라 바람이 많이 불어서 바람을 최대한 등지고 사진 찍기! 인물을 너무 멀리서 찍기보다는 가까이에서 얼굴 보이게 찍는것이 더 예쁘더라고요."
                            ,
                        ...
                        TempSpotDetailResponse.of("동문재래시장", 33.5115902822492, 126.526018218964,
                            "1. 제주도 기념품 사가야 한다면 회 포장 기다리면서 재래시장쪽 둘러보는거 추천드려요. 제주공항에서 사는 것보다 훨씬 사게 구매 가능해요."
                            ,
                ...
                TempScheduleDetailResponse.of(
                    List.of(
                        TempSpotDetailResponse.of("대우정", 33.4989134428429, 126.519577334316,
                            "1. 사진을 찍기에는 분위기가 너무 식당스러워서 음식만 찍어야 해요. 사실 보이는 것보다 사진이 좀 잘 나와서 당황스러운 곳이에요. \n"
                        ...
                        TempSpotDetailResponse.of("돌카롱", 33.4985217309384, 126.513645600081,
                            "1. 주차는 어려워서 일행이 있다면 초스피드 필요! 저희는 밥 먹고 천천히 걸어갔답니다. "
                            ,
                        ...
                        TempSpotDetailResponse.of("푸른밤의해안속초식당", 33.4624621496069, 126.451488498327,
                            "1. 주차공간 엄청 넓습니다. 일행이 많거나 단체일 경우에 방문하면 편할 것 같아요.\n"
                                + "2. 구이류 보다는 조림을 시키는 거 추천드리고, 조림은 인수보다 넉넉하게 시키기! "
                            ,
                ...
                TempScheduleDetailResponse.of(
                    List.of(
                        TempSpotDetailResponse.of("스타벅스 제주도남DT점", 33.4727008501526,
                            126.348753870498,
                            "1. 리유저블 컵을 반납하기 어려운신 분들은 제주공항에 그 컵을 들고 가시면 수속밟기 전에 식수대 있는 곳을 잘 보시면 해피해빗이라고 리유저블 컵 반납기를 찾을 수 있어요. 음료를 결제할 때 부과했던 1000원은 현금, 스타벅스 카드 (충전금), 혹은 해피해빗 포인트로 환불 받을 수 있어요."
                            ,
                        ...
                        TempSpotDetailResponse.of("제주승마공원", 33.405112650286, 126.406064378018,
                            "1. 제주승마공원은 차로 이동하는게 편할 것 같아요. 지리적으로 승마공원은 높은 언덕 위에 위치해 있기 때문이에요. 공원 입구쪽에 주차공간은 넉넉했어요.\n"
