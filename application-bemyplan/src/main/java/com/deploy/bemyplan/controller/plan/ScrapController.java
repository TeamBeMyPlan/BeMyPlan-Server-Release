...
public class ScrapController {
    ...
    public ResponseEntity<String> addScrap(@PathVariable final Long planId, @UserId final Long userId){
    ...
    public ResponseEntity<String> deleteScrap(@UserId final Long userId, @PathVariable final Long planId){
    ...
    public ResponseEntity<String> checkScrapStatus(@PathVariable final Long planId, @UserId final Long userId){
        scrapService.checkScrapStatus(planId, userId);
        return ResponseEntity.ok("해당 여행일정을 스크랩 한 상태입니다.");
    }
}
